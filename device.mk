...
PRODUCT_COPY_FILES += \
    ...
    device/lge/bullhead/fstab.bullhead:$(TARGET_COPY_OUT)/ramdisk/fstab.bullhead \
...
PRODUCT_COPY_FILES += \
    ...
    device/lge/bullhead/media_profiles_V1_0.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/media_profiles_V1_0.xml
...
# Library used for VTS profiling (only for eng builds)
ifneq (,$(filter eng, $(TARGET_BUILD_VARIANT)))
PRODUCT_PACKAGES += \
    libvts_profiling \
